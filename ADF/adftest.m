...
% $Revision: 1.1.6.12 $ $Date: 2010/10/08 16:40:59 $
...
if any(alpha < minAlpha) || any(alpha > maxAlpha)
    ...
    error('econ:adftest:AlphaOutOfRange',...
...
if strcmpi(testType,'F') % Right-tailed test
    ...
    if testStat >= CVTableRowT(1)
        ...
        warning('econ:adftest:RightTailStatTooBig',...
    ...
    elseif testStat <= CVTableRowT(end)
        ...
        warning('econ:adftest:RightTailStatTooSmall',...
    ...
    if testStat <= CVTableRowT(1)
        ...
        testPValue = sigLevels(1);
        warning('econ:adftest:LeftTailStatTooSmall',...
                'Test statistic #%d below tabulated critical values: \nminimum p-value = %5.3f reported.',i,testPValue)
            
    elseif testStat >= CVTableRowT(end)
        
        testPValue = sigLevels(end);
        warning('econ:adftest:LeftTailStatTooBig',...
                'Test statistic #%d above tabulated critical values: \nmaximum p-value = %5.3f reported.',i,testPValue)
